        ...
        <div className="min-h-screen bg-[#faf6ee]">
            <div className="bg-[#1a3a2e] px-10 py-18">
                <div className="max-w-6xl mx-auto flex items-start justify-center flex-wrap">
                    <div>
                        <h1 className="text-white text-4xl font-bold mb-2.5 text-center">Caregiver Community</h1>
                        <p className="text-sm text-[#9ab89a] font-thin text-center">You aren&apos;t meant to do this alone. Join a specialized support group to <br></br>find connection, shared wisdom, and emotional support.</p>
                    </div>
                </div>
            </div>
            <div className="m-12">
